...
write_metadata_fixture <- function(path) {
  writeLines(
    c(
      "filename,dta_path,published,do_path,version_label,classification",
      "AAA_2020_SURV_V01_M_V01_A_GLD,BASE/AAA/AAA_2020_SURV/AAA_2020_SURV_V01_M_V01_A_GLD/Data/Harmonized/AAA_2020_SURV_V01_M_V01_A_GLD_ALL.dta,false,,,",
      "BBB_2019_SURV_V01_M_V01_A_GLD,BASE/BBB/BBB_2019_SURV/BBB_2019_SURV_V01_M_V01_A_GLD/Data/Harmonized/BBB_2019_SURV_V01_M_V01_A_GLD_ALL.dta,false,,,Official Use",
      "CCC_2018_SURV_V01_M_V01_A_GLD,BASE/CCC/CCC_2018_SURV/CCC_2018_SURV_V01_M_V01_A_GLD/Data/Harmonized/CCC_2018_SURV_V01_M_V01_A_GLD_ALL.dta,true,BASE/CCC/CCC_2018_SURV/CCC_2018_SURV_V01_M_V01_A_GLD/Programs/CCC_2018_SURV_V01_M_V01_A_GLD_ALL.do,Existing label,"
    ),
    path
  )
}
...
test_that("metadata parsing pipeline updates do_path and version_label for unpublished rows", {
  ...
  tmp <- tempdir()
  fixture_path <- file.path(tmp, "metadata_fixture.csv")
  write_metadata_fixture(fixture_path)
...
test_that("metadata parsing pipeline updates classification for unpublished rows missing classification", {
  ...
  tmp <- tempdir()
  fixture_path <- file.path(tmp, "metadata_fixture_class.csv")
  write_metadata_fixture(fixture_path)
